...
class ShipperDetails extends StatelessWidget {
  const ShipperDetails({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    appbarTitle: "Shipper Details", 
    widget: ListView(
      children: [
        Padding(
          padding: const EdgeInsets.only(left:10.0,right:8,top:15),
          child: ShipperStepper(width: MediaQuery.of(context).size.width),
        ),
      Padding(
                ...
                Center(
                  child: SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context)=>const ConsigneeDetails()));
                      },
                      child: Text(
                        'Next',
